...
sudo mkdir -p /srv/www/2022.cappuchino/data/FCyT/2025-01
sudo cp data/FCyT/2025-01/*.json /srv/www/2022.cappuchino/data/FCyT/2025-01/.
sudo cp data/FCyT/2025-01.json   /srv/www/2022.cappuchino/data/FCyT/.
