...
Compress-Archive -Path .\public\* -DestinationPath downloads-server\2020.cappuchino\2021-02.3.cappuchino.zip
scp -P9195 .\downloads-server\2020.cappuchino\2021-02.3.cappuchino.zip scesi@dozer-ssh.scesi.org:~/.

# sudo unzip 2021-02.3.cappuchino.zip -d /srv/www/2021.cappuchino
# firebase deploy
